...
from model.user_presence.V2_audits_entitytype__id__entityid__id_ import V2_audits_entitytype__id__entityid__id_  # noqa: F401,E501

class AWSEvent(object):


    _types = {
        'detail': 'V2_audits_entitytype__id__entityid__id_',
        'account': 'str',
        'detail_type': 'str',
        'id': 'str',
        'region': 'str',
